...
本仓库的核心学习方法直接参考 Rahul 在 X 发布的文章：[《How To Learn Anything 10x Faster Using Claude》](https://x.com/sairahul1/article/2068250224532050089)。文章提出了一套把 AI 从“答案生成器”转变为“学习教练”的方法，核心包括：

1. 建立从初学者到熟练实践者的五级学习阶梯；
2. 用 20 小时和 80/20 原则抓住最重要的知识；
3. 为核心主题制作可以在 5 分钟内复习的一页速查表；
4. 从大量资料中筛选少量高杠杆学习资源；
5. 通过逐题、渐进式闭卷测验暴露真正的知识缺口；
6. 使用费曼学习循环反复复述、发现缺口并针对性重学。

本仓库将这些方法落实为：**先诊断、后规划；以问题驱动学习；用图形、计算、案例、闭卷测验、错题记录和间隔复习形成可验证证据；不把“看懂了”当成“掌握了”。**文章以 Claude 为例，但本仓库不绑定具体 AI 模型，重点是保留这套学习流程。

[`localization-mapping-learning`](https://github.com/XiaoJiNu/localization-mapping-learning) 是我此前将这套方法应用到定位建图领域的实践。本仓库会参考它的目录组织和公开记录方式，但学习方法的直接引用来源是 Rahul 的上述文章。
